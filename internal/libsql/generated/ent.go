...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			bdverseref.Table:        bdverseref.ValidColumn,
			bibledictentry.Table:    bibledictentry.ValidColumn,
			book.Table:              book.ValidColumn,
			chapter.Table:           chapter.ValidColumn,
			idxverseref.Table:       idxverseref.ValidColumn,
			indexentry.Table:        indexentry.ValidColumn,
			jstpassage.Table:        jstpassage.ValidColumn,
			tgverseref.Table:        tgverseref.ValidColumn,
			topicalguideentry.Table: topicalguideentry.ValidColumn,
			verse.Table:             verse.ValidColumn,
			versebdref.Table:        versebdref.ValidColumn,
			versecrossref.Table:     versecrossref.ValidColumn,
			versegroup.Table:        versegroup.ValidColumn,
			versejstref.Table:       versejstref.ValidColumn,
			versetgref.Table:        versetgref.ValidColumn,
